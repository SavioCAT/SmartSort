...
class controleur_moteur:
    ...
    def set_duty(self, moteur: int, duty: float) -> None:
        try:
            ...
            if moteur == 1:
                self.pwm_moteur1.duty_u16(65535 / 100 * duty)
            elif moteur == 2:
                self.pwm_moteur2.duty_u16(65535 / 100 * duty)
            elif moteur == 3:
                self.pwm_moteur3.duty_u16(65535 / 100 * duty)
            elif moteur == 4:
                self.pwm_moteur4.duty_u16(65535 / 100 * duty)
